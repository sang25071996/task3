...
This Payment Gateway For WooCommerce extends the functionality of WooCommerce to accept payments from credit/debit cards using Authorize.net Gateway
...
<h3>Latest WooCommerce v2.5.x Compatible</h3>
